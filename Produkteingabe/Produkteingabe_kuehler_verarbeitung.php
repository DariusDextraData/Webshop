...
<?php
    ...
    $Sockel = $_POST["Sockel"];
    $Kuehlart  = $_POST["Kuehlart"];
    $Drehzahl = $_POST["Drehzahl"];
    $Radiatorgroesse = $_POST["Radiatorgroesse"];
?>
</form>
...
//________________________________________________________________________________________________________________________________________________________________
    ...
    $Abfrage = "SELECT MAX(ArtikelNr) AS MaxArtikelNr FROM kuehler";

    $result = mysqli_query($connect, $Abfrage); /*$result = Abfrage wird an die DB gesendet*/

    $KuehlerAdd = "INSERT INTO kuehler VALUES('$ArtikelNr', '$Hersteller', '$Produktname', '$Einzelpreis','$Sockel','$Kuehlart','$Drehzahl','$Radiatorgroesse');";
...
//________________________________________________________________________________________________________________________________________________________________
        ...
        if(isset($_POST['Send']))
        {
            ...
            mysqli_query($connect, $KuehlerAdd) or die (mysqli_error($connect));
            }
                else {
                /*Wenn keine Nr in der Tabelle gefunden wurde wird diese neu gesetzt.*/
                $ArtikelNr = 1070000001;
                mysqli_query($connect, $KuehlerAdd) or die (mysqli_error($connect));
                }
        }
